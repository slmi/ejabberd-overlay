...
CDEPEND="
	...
	sip? ( >=dev-erlang/esip-1.0.27 )
	sqlite? ( >=dev-erlang/sqlite3-1.1.6 )
	stun? ( >=dev-erlang/stun-1.0.26 )
...
DOCS=( README.md )
PATCHES=( "${FILESDIR}/${PN}-18.09-ejabberdctl.patch"
	"${FILESDIR}/${PN}-18.09-0002-Dont-overwrite-service-file.patch" )
